...
class YouTubeDownloader(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Preferences action opens a detailed Preferences dialog
        pref_action = settings_menu.addAction(self._tr('preferences'))
        pref_action.triggered.connect(self._open_preferences)

        # Tools and Convert under tools
        tools_action = tools_menu.addAction(self._tr('tools'))
        tools_action.triggered.connect(lambda: self._show_coming_soon(self._tr('tools')))
